...
// 防止类重复声明（与其他插件兼容）
if (!class_exists('Saiita_AI_Toolkit_Logger')) {

    class Saiita_AI_Toolkit_Logger
    {
        /**
         * 日志前缀
         */
        const LOG_PREFIX = 'Saiita AI Content Toolkit';
...
} // endif class_exists Saiita_AI_Toolkit_Logger

// 简化的日志函数别名
if (!function_exists('wt_log_error')) {
    function wt_log_error($message, $module = 'general', $context = array())  // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound
    {
        Saiita_AI_Toolkit_Logger::error($message, $module, $context);
    }
}

if (!function_exists('wt_log_info')) {
    function wt_log_info($message, $module = 'general', $context = array())  // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound
    {
        Saiita_AI_Toolkit_Logger::info($message, $module, $context);
    }
}

if (!function_exists('wt_log_debug')) {
    function wt_log_debug($message, $module = 'general', $context = array())  // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound
    {
        Saiita_AI_Toolkit_Logger::debug($message, $module, $context);
    }
}

if (!function_exists('wt_log_warning')) {
    function wt_log_warning($message, $module = 'general', $context = array())  // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound
    {
        Saiita_AI_Toolkit_Logger::warning($message, $module, $context);
    }
}

if (!function_exists('wt_log_critical')) {
    function wt_log_critical($message, $module = 'general', $context = array())  // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound
    {
        Saiita_AI_Toolkit_Logger::critical($message, $module, $context);
    }
}

if (!function_exists('wt_log_database_error')) {
    function wt_log_database_error($message, $module = 'database', $sql_error = '')  // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound
    {
        Saiita_AI_Toolkit_Logger::database_error($message, $module, $sql_error);
    }
}
