...
(function(window, $) {
    ...
    window.ToolkitCore = {
        ...
        showErrors: function(errors) {
            ...
            if ($errorContainer.length === 0) {
                ...
                $('.wrap h1, .gdpr-admin-header h1').first().after($errorContainer);
            }
        ...
        initNotices: function() {
            ...
            if ($noticeContainer.length === 0) {
                ...
                $('.wrap h1, .gdpr-admin-header h1').first().after($noticeContainer);
            }
        },
    ...
    $(document).ready(function() {
        // 检查是否有全局配置
        var globalConfig = window.SaiitaAIToolkitConfig || {};
