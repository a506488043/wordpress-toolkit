                            ...
                            <?php foreach ($items as $item): ?>
                                ...
                                <div class="tc-item-new" data-category="<?php echo esc_attr($item_category); ?>">
                                    <div class="tc-item-header">
                                        ...
                                        <div class="tc-item-info">
                                            ...
                                            <?php if (!empty($item_brand)): ?>
                                                <div class="tc-item-brand"><?php echo esc_html($item_brand); ?></div>
                                            <?php endif; ?>
                                    ...
                                    <?php if (!empty($item_description)): ?>
                                        <div class="tc-item-description"><?php echo esc_html($item_description); ?></div>
                                    <?php endif; ?>
                                    ...
                                    <div class="tc-item-details">
                                        ...
                                        <?php endif; ?>
                                        <div class="tc-detail-item">
                                            <span class="tc-detail-label">使用时间</span>
                                            <span class="tc-detail-value">
                                                ...
                                                echo $usage_interval->y . '年' . $usage_interval->m . '个月';
                                                ?>
                                            </span>
                                        </div>
                                    </div>
